...
async function actionCommands(layerId, title) {
...
module.exports = async function runModalFunction(layerId, title) {
   await executeAsModal(() => actionCommands(layerId, title), {"commandName": "Action Commands"});
}
